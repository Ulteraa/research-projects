...
from ultralytics.nn.tasks import DetectionModel, SegmentationModel, WorldModel, PoseSegmentModel
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if any(f):
            ...
            predict_data = f"data={data}" if model.task == "pose_segment" and fmt == "pb" else ""
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        elif isinstance(self.model, PoseSegmentModel):
        ...
        if dynamic:
            ...
            if isinstance(self.model, SegmentationModel):
                ...
                dynamic["output0"] = {0: "batch", 2: "anchors"}  # Detection
                dynamic["output1"] = {0: "batch", 2: "mask_height", 3: "mask_width"}  # Segmentation masks
    ...
    def _add_tflite_metadata(self, file):
        ...
        elif self.model.task == "pose_segment":
            output2 = schema.TensorMetadataT()
            output2.name = "output"
            output2.description = "Mask protos"
            output2.associatedFiles = [label_file]
