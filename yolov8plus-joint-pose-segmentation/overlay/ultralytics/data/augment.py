...
class RandomFlip:
    ...
    def __call__(self, labels):
        ...
        if self.direction == "horizontal" and random.random() < self.p:
            ...
            instances.fliplr(w)
            # For keypoints
            if self.flip_idx is not None and instances.keypoints is not None  and instances.keypoints.size > 0:
...
class Format:
    ...
    def __call__(self, labels):
        ...
        if self.return_keypoint and instances.keypoints is not None  and instances.keypoints.size > 0:
