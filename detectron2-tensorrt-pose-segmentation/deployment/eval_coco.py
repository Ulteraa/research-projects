    ...
    for batch, images, scales in batcher.get_batch():
        ...
        for i in range(len(images)):
            ...
            for n in range(num_instances):
                ...
                pred_boxes.append([det['xmin'], det['ymin'], det['xmax'], det['ymax']])
                # Append score.
                scores.append(det['score'])
                # Append class.
                pred_classes.append(det['class'])
                pred_keypoints.append(det['keypoints'])
                # Append mask.
            ...
            if pred_keypoints:
                instances.pred_keypoints = torch.as_tensor(np.asarray(pred_keypoints))
