...
ROOT = Path(
    ...
    "tum_fr1_room_baseline"
)

MESH_PATH = (
    ROOT
    / "tsdf/final/portfolio/"
    "tum_fr1_room_portfolio_crop_200k.ply"
)

OUTPUT_DIR = (
    ROOT / "structure_coverage_positive_control"
)
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OUTPUT_JSON = OUTPUT_DIR / "room_structure_coverage.json"
OUTPUT_TOPDOWN = OUTPUT_DIR / "room_structure_coverage.png"
OUTPUT_HISTOGRAM = OUTPUT_DIR / "room_plane_histograms.png"
...
all_walls_pass = bool(
    ...
    and all(
        score["passes"]
        for score in wall_scores.values()
    )
)
